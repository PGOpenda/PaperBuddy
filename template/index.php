...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <form class="p-3 needs-validation" novalidate action="../src/login.php" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="email" class="form-control p-3 text-light" id="floatingInput" name="email" placeholder="Email address" required>
                            <div class="invalid-feedback">
                                Please provide a valid email address
                            </div>
                        </div>
                        <div class="mb-3">
                            <input type="password" class="form-control p-3 text-light" id="floatingPassword" name="password" placeholder="Password" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-sign">
                            <p> Forgotten your <a data-bs-toggle="modal" data-bs-target="#signupModal" href="">password?</a> </p>
                        </div>
    ...
    <div class="modal fade" id="signupModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <form class="p-1 needs-validation" novalidate action="../src/signup.php" method="POST">
                        <img src="../static/images/logo3.png" alt="logo" class="img-fluid mx-auto d-block mb-4">
                        <h1 class="h3 mb-3 fw-normal text-center">SIGN UP</h1>

                        <div class="row mb-3">
                            <div class="col">
                                <input type="text" class="form-control p-3 text-light" id="FirstName" name="firstname" placeholder="First Name" required> 
                                <div class="invalid-feedback">
                                    First Name needed!
                                </div>
                            </div>
                            <div class="col">
                                <input type="text" class="form-control p-3 text-light" id="LastName" name="lastname" placeholder="Last Name" required>
                                <div class="invalid-feedback">
                                    Last Name needed!
                                </div>
                            </div>    
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <select class="form-select p-3" id="Gender" name="gender" aria-label="Select for type of gender" required>
                            ...
                            <div class="col">
                                <input type="email" class="form-control p-3 text-light" id="Email" name="email" placeholder="Email address" required>
                                <div class="invalid-feedback">
                                    Email needed!
                                </div>
                            </div>   
                        ...
                        <div class="row mb-3">
                        <div class="col">
                                <input type="password" class="form-control p-3 text-light" name="password" id="Password" placeholder="Password" required>
                            </div>
                            <div class="col">
                                <input type="password" class="form-control p-3 text-light" id="ConfirmPass" placeholder="Confirm Password" required>
                            </div>
                        </div>
